...
#ifndef OMPL_GEOMETRIC_PLANNERS_BITSTAR_DATASTRUCTURES_MULTIELLIPSOIDSAMPLERH_
#define OMPL_GEOMETRIC_PLANNERS_BITSTAR_DATASTRUCTURES_MULTIELLIPSOIDSAMPLERH_
