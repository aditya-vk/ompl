...
namespace ompl
{
    namespace geometric
    {
        using blaze::Edge;
        using blaze::Event;
        using blaze::EventPtr;
        using blaze::ImplicitGraph;
        using blaze::ImplicitGraphPtr;
        using blaze::RepairQueue;
        using blaze::RepairQueuePtr;
        using blaze::SearchQueue;
        using blaze::SearchQueuePtr;
        using blaze::Selector;
        using blaze::SelectorPtr;
        using blaze::Vertex;
        using blaze::VertexID;
        using blaze::VertexIDVector;
        using blaze::VertexPtr;

        // ============================================================================================
        Blaze::Blaze(const ompl::base::SpaceInformationPtr &si, const std::string &name) : ompl::base::Planner(si, name)
        {
            // Do nothing.
        }
